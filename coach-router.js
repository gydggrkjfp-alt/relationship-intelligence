...
function classify(input={}){
 ...
 if(has(raw,/what women want|understand women|why women|why she|why girls|female behavior|mixed signals|mixed signal|inconsistent over text|inconsistent text|inconsistent communication|warm in person|interested in person|slow to reply|slow reply|slow replies|do not want to chase|don't want to chase|dont want to chase|miss a real opportunity|hesitat|indirect|passive|test me|testing me|pull back|hot and cold/)){add(scores,'early',24,'female-behavior dating language');add(scores,'early_signal',26,'understanding female-side signals');add(scores,'grounding_values',-22,'mixed-signal dating language is not primarily life reset');}
