const STORAGE_KEY='relationship_intelligence_pwa_v10';
...
function renderEcosystem(){
  ...
  renderNutrients();renderDeficiencies();renderCultivation();drawEcosystemCanvas();
}
