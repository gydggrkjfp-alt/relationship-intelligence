const STORAGE_KEY='relationship_intelligence_pwa_v12';
...
if($('deficiencyChecks'))$('deficiencyChecks').innerHTML='<div class="checkGrid">'+deficiencyDefs.map(([k,l])=>`<label class="checkItem"><input type="checkbox" id="def_${k}"><span>${l}</span></label>`).join('')+'</div>';
if($('patternChecks'))$('patternChecks').innerHTML='<div class="checkGrid">'+patternDefs.map(([k,l])=>`<label class="checkItem"><input type="checkbox" id="pattern_${k}"><span>${l}</span></label>`).join('')+'</div>';
if($('tendencyChecks'))$('tendencyChecks').innerHTML='<div class="checkGrid">'+blindSpotDefs.map(([k,l])=>`<label class="checkItem"><input type="checkbox" id="blind_${k}"><span>${l}</span></label>`).join('')+'</div>';
