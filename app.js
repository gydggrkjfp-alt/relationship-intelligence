...
function fillCoach380(){
 const p=profile380(),c=p?.coach380||{};if($380('coachSituation380'))$380('coachSituation380').value=c.situation||'';if($380('coachQuestion380'))$380('coachQuestion380').value=c.question||'';if($380('coachStage380'))$380('coachStage380').value=c.stage||'auto';if($380('coachUserRole380'))$380('coachUserRole380').value=c.userRole||'auto';if($380('coachTargetRole380'))$380('coachTargetRole380').value=c.targetRole||'auto';
}
function saveCoach380(){
 ...
 p.coach380={...(p.coach380||{}),situation:$380('coachSituation380')?.value||'',question:$380('coachQuestion380')?.value||'',stage:$380('coachStage380')?.value||'auto',userRole:$380('coachUserRole380')?.value||'auto',targetRole:$380('coachTargetRole380')?.value||'auto',goal:'Get grounded and choose the next move',grounding:'auto',updated:new Date().toISOString()};
 if(typeof saveState==='function')saveState();
 renderCoach380();
...
function bindCoach380(){
 ...
 ['coachSituation380','coachQuestion380','coachStage380','coachUserRole380','coachTargetRole380'].forEach(id=>{const el=$380(id);if(el)el.addEventListener('input',()=>{const p=profile380();if(!p)return;p.coach380={...(p.coach380||{}),situation:$380('coachSituation380')?.value||'',question:$380('coachQuestion380')?.value||'',stage:$380('coachStage380')?.value||'auto',userRole:$380('coachUserRole380')?.value||'auto',targetRole:$380('coachTargetRole380')?.value||'auto',goal:'Get grounded and choose the next move',grounding:'auto'};renderCoach380();});});
