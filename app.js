...
function coachTitle380(stage,crux){
...
function stageFrame380(stage,crux,raw=''){
...
function advice380(stage,crux,goal,raw,people){
  ...
  script:'“I like talking with you. Let’s do something simple this week: coffee or a walk Thursday?”'
	 ...
	 if(stage==='early'&&crux==='early_signal'&&people?.user==='man'&&people?.target==='woman'&&/what women want|understand women|why women|why she|why girls|female behavior|mixed signals|hesitat|indirect|passive|test me|testing me|pull back|hot and cold|from her side|taken out|care for me|wants to care/.test(rawT)){
	  ...
	  if(/sex|attention|what (do )?women want|relationship opportunity/.test(rawT))return{...early,next:'A woman may want more than dates, attention, or sexual tension: she may want a stable opportunity to enter a man’s life and matter there. The coaching move is to show direction, warmth, boundaries, and a useful role. Then sex and affection become part of a larger context instead of the whole offer.',pitfalls:['Offering entertainment and desire but no life for her to join.','Making sex the proof of progress before reciprocity is visible.','Assuming women are mysterious when the opportunity is simply unclear.'],adopt:['Make your real life legible: goals, friends, responsibilities, values.','Create one small teamwork moment before escalating the fantasy.','Notice whether she becomes more caring when she has a role.'],eliminate:['Selling yourself as only fun, available, and sexually interested.','Overproviding while asking for nothing.','Bitterness about women instead of clearer selection.'],script:'“I’m attracted to you, and I also like seeing whether we work well in real life. Want to help me think through this?”'};
	  return{...early,next:'Read her behavior as a response to the relationship opportunity in front of her, not only as a yes/no attraction signal. She may be asking whether your life has direction, whether her care would matter, whether you only want attention or sex, and whether there is a dignified role for her besides being entertained. Give her one warm, proportionate path to participate, then watch what she does.',pitfalls:['Assuming female indirectness means she is malicious, when she may be calibrating safety, role, and seriousness.','Explaining endlessly instead of creating a clearer context for her to enter.','Using this frame to excuse disrespect, entitlement, or chronic passivity.'],adopt:['Keep your life, direction, friends, work, faith/values, and responsibilities visible.','Invite one small useful contribution: help choose, bring, care, plan, remember, or solve something proportionate.','Notice whether contribution makes her warmer, more invested, and easier to respect.'],eliminate:['A dating dynamic where your only value is entertainment, logistics, reassurance, or sexual pursuit.','Bitterness that turns all hesitation into a verdict on women.','Secret tests; make the invitation dignified and ordinary.'],script:'“I like when dating has some real teamwork in it. Would you help me think through this plan?”'};
	 }
...
function geniusChatHTML380(p,stage,crux,raw,people){
 ...
 if(rows.length&&stage==='early'&&people?.user==='man'&&people?.target==='woman'){
...
function questions380(stage,crux,raw){
